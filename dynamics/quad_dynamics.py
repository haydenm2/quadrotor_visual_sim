...
class quad_dynamics:
    ...
    def update_state(self, inputs):
        ...
        self._state += np.array([[0],
                                 [0],
                                 [0],
                                 [np.random.randn()*self.Q.item((0, 0))],
    ...
    def update_sensors(self):
        self.sensor_measurements.pn = self._state.item(0)
        self.sensor_measurements.pe = self._state.item(1)
        self.sensor_measurements.pd = self._state.item(2)
        self.sensor_measurements.u = self._state.item(3) + np.random.randn()*self.R.item((0, 0))
        self.sensor_measurements.v = self._state.item(4) + np.random.randn()*self.R.item((1, 1))
        self.sensor_measurements.w = self._state.item(5) + np.random.randn()*self.R.item((2, 2))
        self.sensor_measurements.phi = self._state.item(6) + np.random.randn()*self.R.item((3, 3))
        self.sensor_measurements.theta = self._state.item(7) + np.random.randn()*self.R.item((4, 4))
        self.sensor_measurements.psi = self._state.item(8) + np.random.randn()*self.R.item((5, 5))
        self.sensor_measurements.p = self._state.item(9) + np.random.randn()*self.R.item((6, 6))
        self.sensor_measurements.q = self._state.item(10) + np.random.randn()*self.R.item((7, 7))
        self.sensor_measurements.r = self._state.item(11) + np.random.randn()*self.R.item((8, 8))
